...
const socials = [
  ...
  { label: "Instagram", href: "https://www.instagram.com/rydvestltd", icon: <Instagram /> },
  { label: "TikTok", href: "https://www.tiktok.com/@rydvest", icon: <TikTok /> },
            ...
            <div className="flex gap-3 flex-wrap">
              {socials.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 rounded-xl bg-white/5 border border-white/8 text-slate-400 hover:bg-amber-400 hover:border-amber-400 hover:text-[#0d2137] flex items-center justify-center transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
              ...
              {contact.map((c) => (
                <li key={c.label}>
                  ...
                  >
                    ...
                    <span className="text-sm text-slate-500 group-hover:text-amber-400 transition-colors duration-150 leading-relaxed">
                      {c.label}
                    </span>
                  </a>
                </li>
