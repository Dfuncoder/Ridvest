...
export function HowItWorks() {
  return (
    <section id="hiw" style={{ padding: "72px 40px", background: "#0d2137" }}>
      <div style={{ textAlign: "center", marginBottom: 52 }}>
        ...
        <h2 style={{ fontSize: 36, fontWeight: 800, color: "#fff", letterSpacing: -0.5, marginBottom: 12 }}>Simple as 1, 2, 3, 4</h2>
  ...
  return (
    <section style={{ padding: "72px 40px", background: "#fff" }}>
      <div style={{ textAlign: "center", marginBottom: 52 }}>
        ...
        <h2 style={{ fontSize: 36, fontWeight: 800, color: "#0f172a", letterSpacing: -0.5, marginBottom: 12 }}>Built for Nigerian investors</h2>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20, maxWidth: 1000, margin: "0 auto" }}>
        {whys.map((w) => (
          <div key={w.title} style={{ padding: 28, border: "0.5px solid #e2e8f0", borderRadius: 16, transition: "all 0.3s" }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: "#f0f6ff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, marginBottom: 16 }}>{w.icon}</div>
