...
export default function Calculator() {
  ...
  return (
    <section id="calc" style={{ background: "#f8faff", padding: "clamp(48px, 8vw, 80px) 20px" }}>
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ maxWidth: 680, margin: "0 auto", background: "#fff", borderRadius: 24, padding: "clamp(24px, 6vw, 48px)", border: "1px solid #e2e8f0", boxShadow: "0 6px 32px rgba(13,33,55,0.06)" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", background: "#f0f6ff", borderRadius: 14, padding: "14px 16px", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
            <div style={{ fontSize: 13, color: "#64748b", fontWeight: 500, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
              {[
                ...
                <div key={r.label} style={{ background: "#0d2137", borderRadius: 16, padding: "24px 20px", textAlign: "center" }}>
                  ...
                  <div style={{ fontSize: "clamp(22px, 4vw, 30px)", fontWeight: 800, color: r.accent ? "#f59e0b" : "#fff" }}>{r.value}</div>
                </div>
              ))}
            </div>
          ) : (
