...
'@
  ...
  @{
    Path = "components/InvestmentCards.tsx"
    Content = @'
const vehicles = [
  {
...
'@
  ...
  @{
    Path = "components/VehicleLineup.tsx"
    Content = @'
const vehicles = [
  {
    name: "🛺 Keke Napep",
...
'@
  ...
  @{
    Path = "components/StatsStrip.tsx"
    Content = @'
const stats = [
...
'@
  ...
  @{
    Path = "components/WhyRidvest.tsx"
    Content = @'
const items = [
...
Write-Host "Updated $($files.Count) component files."
